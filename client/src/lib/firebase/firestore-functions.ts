...
import type { LobbyRequest, ErrorResponse, ExpirationRequest } from "./firestore-functions-types";
...
export const verifyExpiration = httpsCallable<ExpirationRequest, void>(functions, "verifyExpiration");
